...
CELLS_DEF="decode 256 512 3.0 259 84 68320
mixed 2048 128 12.0 428 84 12537
prefill_lean 8192 64 12.0 1198 89 7202
prefill_bound 16000 16 8.0 2144 91 2788
hetero 256 64 6.0 259 84 6208"
...
while read -r cell IN O R T I E; do
  ...
  for a in never always kairos least-ttft lt-joint dpp dpvar gp-dep; do

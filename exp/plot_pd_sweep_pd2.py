#!/usr/bin/env python3
"""Plot pd-prefix-threshold sweep results from blis-pd-sweep-thresh/.

One figure per workload. Color distinguishes threshold sweep (blue) from
reference deciders (cost-prop=red, bernoulli=dark yellow, dpp=green).
...
REFERENCES = [
    ("cost-prop", "tab:red",       "cost-prop (budget=2000, floor=1000)"),
    ("bernoulli", "darkgoldenrod", "bernoulli (f=0.5)"),
    ("dpp",       "tab:green",     "dpp (v=100, eta=1.0, slo-d=50)"),
]

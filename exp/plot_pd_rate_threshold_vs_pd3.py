#!/usr/bin/env python3
"""Plot rate-sweep results from blis-pd-sweep-rate_threshold_vs_pd3/.

One figure per workload. Three arms (agg-4xtp4, pd-thresh16, pd-pd3) compared
...
DATA_DIR = "./blis-pd-sweep-rate_threshold_vs_pd3"
...
ARMS = [
    ...
    ("pd-pd3",      "tab:red",    "pd-pd3 (1P+3D, 3-clause: qd=1, kv=0.04, ifr=19, longPrefill=10000)"),
]
...
for name in WORKLOADS:
    ...
    fig.suptitle(f"PD rate sweep: agg vs threshold=16 vs pd3 — {name}", fontsize=14)
    plt.tight_layout()

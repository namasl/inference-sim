#!/usr/bin/env python3
"""Plot rate-sweep results from blis-pd-sweep-rate_scorers_reasoning_derived_chat_code/.

One figure per workload (interactive-chat-3g, code-generation-3g). Three arms
(agg-6xtp4, pd-default, pd-champ) compared across rates. Color encodes arm;
...
DATA_DIR = "./blis-pd-sweep-rate_scorers_reasoning_derived_chat_code"
WORKLOADS = ["interactive-chat-3g", "code-generation-3g"]

# (arm label, color, legend description)
ARMS = [
    ("agg-6xtp4",  "tab:gray", "agg-6xtp4 (6×TP=4, 24 GPU, no PD)"),
